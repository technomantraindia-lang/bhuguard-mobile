...
export function FarmerProjectDetailsScreen() {
  const navigation = useNavigation<Nav>();

  return (
    <ApiListScreen
      title="Project Participation"
      subtitle="Your enrolled Bhuguard projects and services"
      fetcher={getFarmerServices}
      listKeys={['services', 'farmer_services']}
      emptyTitle="No project enrollment"
      emptyMessage="You are not enrolled in a project yet."
      onItemPress={(item) =>
