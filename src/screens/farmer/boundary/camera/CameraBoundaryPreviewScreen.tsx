...
type Props = NativeStackScreenProps<FarmerStackParamList, 'CameraBoundaryPreview'>;

export function CameraBoundaryPreviewScreen({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <BoundaryFlowHeader
        ...
        subtitle="Review your farm boundary before saving."
      ...
      <ScrollView contentContainerStyle={styles.content}>
          ...
          onPress={() => {
            navigation.navigate(
              (boundary.sessionMode === 'onboarding' || boundary.sessionMode === 'prefarm'
                ? routes.preview
                : routes.cameraUploading) as 'CameraBoundaryUploading',
        ...
        <Pressable
          style={styles.outlineButton}
          onPress={() => navigation.navigate(routes.cameraPoints as 'CameraBoundaryPoints', boundaryRouteParams(boundary.farmId ?? undefined))}
        >
