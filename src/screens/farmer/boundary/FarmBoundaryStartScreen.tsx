  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <BoundaryFlowHeader
        ...
        subtitle="Walk around your farm and capture boundary points."
        onBack={() => navigation.goBack()}
      />

      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.farmCard}>
          <Text style={styles.farmLabel}>Selected Farm</Text>
        ...
        <InfoRow label="GPS Accuracy" value={`${boundary.gpsAccuracyLabel} / ${boundary.currentAccuracy?.toFixed(0) ?? '—'}m`} />
        <InfoRow label="Current Latitude" value={boundary.currentLatitude?.toFixed(4) ?? '—'} />
        <InfoRow label="Current Longitude" value={boundary.currentLongitude?.toFixed(4) ?? '—'} />
        ...
        <Text style={styles.unitLabel}>Selected Area Unit</Text>
