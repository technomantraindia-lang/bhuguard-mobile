...
export function FarmerActivityDetailScreen({ navigation, route }: Props) {
  ...
  const handleDownload = () => {
    Alert.alert('Download PDF', 'Activity report download will be available in the next release.');
  };

  const handleViewEvidence = () => {
    Alert.alert('Evidence', `Photos: ${activity?.evidencePhotoCount ?? 0}\nDocuments: ${activity?.documentsCount ?? 0}`);
  };
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        ...
        <View style={styles.actions}>
          ...
          <Pressable style={styles.secondaryButton} onPress={handleViewEvidence}>
