...
interface OfficerInventoryVerificationHeaderProps {
  title: string;
  officerName: string;
  onBackPress: () => void;
...
export function OfficerInventoryVerificationHeader({
  title,
  officerName,
  onBackPress,
  onNotificationsPress,
  onProfilePress,
}: OfficerInventoryVerificationHeaderProps) {
  return (
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 14, fontWeight: '700', color: officerTheme.primary, textAlign: 'center' },
