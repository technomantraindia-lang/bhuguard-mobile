...
interface OfficerMrvVerificationHeaderProps {
  officerName: string;
  onBackPress: () => void;
...
export function OfficerMrvVerificationHeader({
  officerName,
  onBackPress,
  onNotificationsPress,
  onProfilePress,
}: OfficerMrvVerificationHeaderProps) {
  return (
    <View style={styles.bar}>
      ...
      <View style={styles.center}>
        ...
        <Text style={styles.title}>Visit Verification Checklist</Text>
      </View>
