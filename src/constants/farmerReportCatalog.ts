...
export const FARMER_REPORT_CATALOG: FarmerReportCatalogEntry[] = [
  {
    ...
    description: 'Latest soil assessment report',
    icon: 'agriculture',
  ...
  },
  {
    ...
    description: 'Initial farm assessment report',
    icon: 'analytics',
    statusBadge: 'available',
    sourceType: 'baseline',
  },
  ...
  },
  {
    ...
    description: 'Field officer verification report',
    icon: 'verified',
  ...
  },
  {
    ...
    description: 'Summary of submitted activities',
    icon: 'assignment',
    statusBadge: 'updated',
    sourceType: 'activity',
  },
